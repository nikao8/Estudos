...
@client.event
async def on_message(message): # SO EXECUTA QUANDO É ENVIADO UMA MENSAGEM
  
  if message.content.startswith('>>setchannel'):
    channel_ids = message.channel.id
    print(channel_ids)
    await message.channel.send('Sexta dos crias setadas neste canal!')
    ...
    while (infinity_loop == 1):
      ...
      if(horario_agora >= '23:29:00' and horario_agora <= '23:29:03' and diaStr == 'Friday'):
        await client.get_channel(channel_ids).send('https://cdn.discordapp.com/attachments/767871106035875880/865399647682166864/sexta_dos_crias_nessa_porra_caralho_tavam_com_saudades_-_-.mp4')
        time.sleep(9)
